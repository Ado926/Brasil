...
const handler = async (m, {conn, usedPrefix, command}) => {
  ...
  conn.reply(m.chat, `《✧》 Debes esperar ${msToTime(time - new Date())} para usar #robxp de nuevo.`, m);
  return;
  }
  let who;
  ...
  if (!who) {
  conn.reply(m.chat, `《✧》 Debes mencionar a alguien para intentar robarle XP.`, m)
  return;
    };
